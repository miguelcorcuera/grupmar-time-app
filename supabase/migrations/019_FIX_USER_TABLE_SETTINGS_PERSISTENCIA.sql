-- ============================================================================
-- GrupMar Time v16.16 - Persistencia dura de cabeceras por usuario
--
-- Refuerza user_table_settings:
-- - columnas visibles
-- - orden de columnas
-- - orden asc/desc
-- - anchos futuros / metadata futura en settings
-- ============================================================================
...
begin
  ...
  insert into public.user_table_settings(
    user_id, email, table_key, visible_columns, column_order, sort_key, sort_dir, settings
  )
  values (
    v_user_id,
    v_email,
...
-- Diagnóstico rápido de preferencias guardadas del usuario actual.
