-- ============================================================================
-- GrupMar Time v16.10.2 - FIX malformed array literal "code"
--
-- Error:
--   malformed array literal: "code"
--
-- Causa:
--   v_cols := v_cols || 'code'
--   PostgreSQL intenta interpretar "code" como array literal.
--
-- Solución:
--   array_append(v_cols, 'code')
-- ============================================================================
