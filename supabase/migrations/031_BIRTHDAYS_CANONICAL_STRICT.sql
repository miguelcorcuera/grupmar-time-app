-- ============================================================================
-- GrupMar Time v16.19.5 - Cumpleaños canónicos estrictos desde profiles
--
-- Esta migración deja funciones limpias y verificables.
-- Bruno con birth_date 1978-06-21 NO sale el 2026-06-20.
-- ============================================================================
...
-- Pruebas esperadas.
select 'HOY_2026_06_20' as prueba, *
from public.gmt_birthdays_today(date '2026-06-20');

select 'MANANA_2026_06_21' as prueba, *
from public.gmt_birthdays_today(date '2026-06-21');
